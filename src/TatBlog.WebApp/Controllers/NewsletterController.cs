    ...
    public class NewsletterController : Controller {
        ...
        public async Task<IActionResult> Subscribe(string email) {
            try {
                ...
                var sub = await _subRepo.GetSubscriberByEmailAsync(email);
        ...
        private void SendEmail(string email) {
            ...
            fileContents = fileContents.Replace("{link}", "https://localhost:7027/Newsletter/UnSubscribe");
